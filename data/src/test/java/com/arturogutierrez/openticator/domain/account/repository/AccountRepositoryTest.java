...
public class AccountRepositoryTest extends ApplicationTestCase {
  ...
  @Mock
  private SyncTimestamp mockSyncTimestamp;
  @Mock
  ...
  public void setUp() {
    ...
    accountRepository = new AccountRepositoryImpl(accountDiskDataStore, mockSyncTimestamp);
  }

  @Test
  public void testAddAccount() {
    given(accountDiskDataStore.add(any())).willReturn(Observable.empty());
