...
enum class Issuer(val identifier: String) {
  ...
  UNKNOWN("unknown"), AWS("aws"), BITCOIN("bitcoin"), DIGITALOCEAN("digitalocean"),
  DROPBOX("dropbox"), EVERNOTE("evernote"), FACEBOOK("facebook"), GITHUB("github"),
  GOOGLE("google"), MICROSOFT("microsoft"), SLACK("slack"), ROBERTSPACEINDUSTRIES("rsi"),
  WORDPRESS("wordpress");
